...
FOREIGN KEY(videogame_id) REFERENCES Elements(element_id)
);
...
FOREIGN KEY(comic_id) REFERENCES Elements(element_id)
);
...
PRIMARY KEY(show_id),
FOREIGN KEY(show_id) REFERENCES Elements(element_id)
);
